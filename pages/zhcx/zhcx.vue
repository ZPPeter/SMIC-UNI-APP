<template>
	<view>
		<view style="display: flex; width:90%;text-align: left; margin-left: 12px;align-items: center;">
			...
			<view class="tj-item">送检明细：查询到{{ lstlength }}条记录。</view>
		</view>
		<view style="display: flex; width:90%;text-align: left; margin-left: 12px;align-items: center;">
		...
		<view class="fab-box fab">
			<view class="fab-circle" @tap="gotoWtdcx()"><text class="iconfont icon-hetongchaxun fontsize"></text></view>
		</view>
	</view>
</template>
...
import WtdList from './veri_list.vue';
